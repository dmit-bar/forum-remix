...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create reddit-remix-app-6c0d
  fly apps create reddit-remix-app-6c0d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app reddit-remix-app-6c0d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app reddit-remix-app-6c0d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'reddit-remix-app-6c0d-staging' does not match app name in config file 'reddit-remix-app-6c0d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name reddit-remix-app-6c0d-db
  fly postgres attach --app reddit-remix-app-6c0d reddit-remix-app-6c0d-db

  fly postgres create --name reddit-remix-app-6c0d-staging-db
  fly postgres attach --app reddit-remix-app-6c0d-staging reddit-remix-app-6c0d-staging-db
  ```
